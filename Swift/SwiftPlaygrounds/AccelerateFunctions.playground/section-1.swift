...
plotArrayInPlayground(arrayToPlot: combinedSineWave, title: "Combined wave (loop addition)")
...
func fft( inputArray:[Double]) -> [Double] {
    ...
    let roots = sqrtF(x: fftMagnitudes) // vDSP_zvmagsD returns squares of the FFT magnitudes, so take the root here
...
let fftOfWave3 = fft(inputArray: combinedSineWave)
...
plotArrayInPlayground(arrayToPlot: fftOfWave1, title: "FFT of sine wave 1")
plotArrayInPlayground(arrayToPlot: fftOfWave2, title: "FFT of sine wave 2")
plotArrayInPlayground(arrayToPlot: fftOfWave3, title: "FFT of combined sine waves")
...
identifyFrequenciesAndAmplitudesOfWaveform(waveform: combinedSineWave)
