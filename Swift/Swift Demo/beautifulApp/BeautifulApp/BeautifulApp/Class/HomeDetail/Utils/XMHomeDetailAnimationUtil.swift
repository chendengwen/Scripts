...
class XMHomeDetailAnimationUtil: NSObject {
    class func homeDetailToolBarToNavAnimation(_ toolView : XMHomeDetailToolView) {
    ...
    class func homeDetailToolBarToScrollAnimation(_ toolView : XMHomeDetailToolView) {
        UIView.animate(withDuration: 0.5, animations: { () -> Void in
