...
class XMHomeDetailController: UIViewController, XMHomeDetailCenterViewDelegate,UIScrollViewDelegate,XMHomeDetailToolViewDelegate {
    ...
    // 模型
    fileprivate var model : XMHomeDataModel!
    // 评论page
...
//        self.automaticallyAdjustsScrollViewInsets = false
    ...
    // scrollview
    fileprivate lazy var centerView : XMHomeDetailCenterView = {
    ...
    fileprivate lazy var returnBtn : UIButton = {
        ...
        returnBtn.addTarget(self, action: #selector(XMHomeDetailController.returnBtnDidClick), for: .touchUpInside)
